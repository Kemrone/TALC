	...
	public String build() {
		  ...
		  String html = "<!DOCTYPE html> \n <html lang=\"fr\"> \n <head> \n <meta charset=\"utf-8\"> ";
	        ...
	        html += "<h1> Rapport de connexion </h1>\n" +
	                ...
	                "\n" +
	                "<p> Pour chaque personne ci-dessous, on retrouve son temps total de connexion sur la plage declarée du cours, ainsi qu'un graphe qui indique les périodes de connexion (en vert) et d'absence de connexion (en blanc). En pointant la souris sur une zone, une bulle affiche les instants de début et de fin de période. \n" +
	                "</p>";
